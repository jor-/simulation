...
# parser.add_argument('-d', '--debug_output', action='store_true', help='Show debug informations.')
...
debug_logging_file = args['debug_logging_file']
...
## eval cost function
cf = Cost_Function_2(years=years, tolerance=tolerance, max_nodes_file=max_nodes_file)
