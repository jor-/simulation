...
if util.batch.universal.system.IS_RZ:
    ...
    COST_FUNCTION_NODES_SETUP_JOB = util.batch.universal.system.NodeSetup(memory=40, node_kind='f_ocean2', nodes=1, cpus=1, total_cpus_max=1, walltime=48, check_for_better=True)
...
if util.batch.universal.system.IS_NEC:
    ...
    COST_FUNCTION_NODES_SETUP_SPINUP = util.batch.universal.system.NodeSetup(memory=JOB_MEMORY_GB, node_kind='clfocean', nodes=4, cpus=16, total_cpus_max=4*24, check_for_better=True)
    COST_FUNCTION_NODES_SETUP_DERIVATIVE = util.batch.universal.system.NodeSetup(memory=JOB_MEMORY_GB, node_kind='clmedium', nodes=3, cpus=16, total_cpus_max=8*24, check_for_better=True)
    COST_FUNCTION_NODES_SETUP_JOB = util.batch.universal.system.NodeSetup(memory=50, node_kind='clmedium', nodes=1, cpus=1, total_cpus_max=1, check_for_better=True, walltime=48)
