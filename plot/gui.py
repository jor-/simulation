...
#
# Created: Mon Aug 12 11:23:09 2013
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(504, 463)
        self.pushButton = QtGui.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(210, 410, 81, 28))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.formLayoutWidget = QtGui.QWidget(Dialog)
        self.formLayoutWidget.setGeometry(QtCore.QRect(20, 20, 460, 208))
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(20, 240, 461, 157))
        ...
        QtCore.QObject.connect(self.lineEdit_2, QtCore.SIGNAL(_fromUtf8("textChanged(QString)")), Dialog.set_lower_value_range)
        QtCore.QObject.connect(self.lineEdit, QtCore.SIGNAL(_fromUtf8("textChanged(QString)")), Dialog.set_upper_value_range)
        ...
        Dialog.setTabOrder(self.comboBox_5, self.comboBox)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_13.setText(_translate("Dialog", "value range:", None))
        self.lineEdit_2.setText(_translate("Dialog", "-inf", None))
        self.lineEdit.setText(_translate("Dialog", "inf", None))
