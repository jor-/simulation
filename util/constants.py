...
BOXES_DF_FILENAME = os.path.join(BOXES_CACHE_DIRNAME, 'df.npy')

WOA_CACHE_DIRNAME = 'WOA'
WOA_F_FILENAME = os.path.join(WOA_CACHE_DIRNAME, 'f_pw.npy')
WOA_DF_FILENAME = os.path.join(WOA_CACHE_DIRNAME, 'df_pw.npy')

WOD_CACHE_DIRNAME = 'WOD'
WOD_F_FILENAME = os.path.join(WOD_CACHE_DIRNAME, 'f_pw_lexsorted.npy')
WOD_DF_FILENAME = os.path.join(WOD_CACHE_DIRNAME, 'df_pw_lexsorted.npy')
