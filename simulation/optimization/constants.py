...
if util.batch.universal.system.IS_RZ:
    ...
    COST_FUNCTION_NODES_SETUP_JOB = util.batch.universal.system.NodeSetup(node_kind='f_ocean2', nodes=1, cpus=1, total_cpus_max=1, check_for_better=True)
...
if util.batch.universal.system.IS_NEC:
    ...
    COST_FUNCTION_NODES_SETUP_TRAJECTORY = util.batch.universal.system.NodeSetup(memory=JOB_MEMORY_GB, node_kind='clmedium', nodes=1, cpus=1, nodes_max=1, walltime=2, check_for_better=True)
