...
def save(model_options, measurements_object, cost_function_name,
    ...
    for time_dim_confidence in (4, 1, 12):
        accuracy_object.confidence_increase(alpha=alpha, time_dim_confidence=time_dim_confidence, time_dim_model=time_dim_model, increases_calculation_relative=True, include_variance_factor=True, parallel=parallel, number_of_measurements=1)
