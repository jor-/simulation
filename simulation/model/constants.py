...
MODEL_DEFAULT_DERIVATIVE_STEP_SIZE = 10**-5
if MODEL_DEFAULT_DERIVATIVE_STEP_SIZE <= 10**-7:
    MODEL_DEFAULT_DERIVATIVE_YEARS = 250
elif MODEL_DEFAULT_DERIVATIVE_STEP_SIZE <= 10**-6:
    MODEL_DEFAULT_DERIVATIVE_YEARS = 500
elif MODEL_DEFAULT_DERIVATIVE_STEP_SIZE <= 10**-5:
    MODEL_DEFAULT_DERIVATIVE_YEARS = 1000
elif MODEL_DEFAULT_DERIVATIVE_STEP_SIZE <= 10**-4:
    MODEL_DEFAULT_DERIVATIVE_YEARS = 2500
elif MODEL_DEFAULT_DERIVATIVE_STEP_SIZE <= 10**-3:
    MODEL_DEFAULT_DERIVATIVE_YEARS = 3500
elif MODEL_DEFAULT_DERIVATIVE_STEP_SIZE <= 10**-2:
    MODEL_DEFAULT_DERIVATIVE_YEARS = 5000
elif MODEL_DEFAULT_DERIVATIVE_STEP_SIZE <= 10**-1:
    MODEL_DEFAULT_DERIVATIVE_YEARS = 7000
else:
    MODEL_DEFAULT_DERIVATIVE_YEARS = 10000
MODEL_DEFAULT_DERIVATIVE_OPTIONS = {'years': MODEL_DEFAULT_DERIVATIVE_YEARS, 'step_size': MODEL_DEFAULT_DERIVATIVE_STEP_SIZE, 'accuracy_order': 2}
...
DATABASE_PARTIAL_DERIVATIVE_FACTOR_ID_INT = '{index:d}_{h_factor:+d}'
DATABASE_PARTIAL_DERIVATIVE_FACTOR_ID_FLOAT_PRECISION = 3
DATABASE_PARTIAL_DERIVATIVE_FACTOR_ID_FLOAT = '{index:d}_{h_factor:+' + str(DATABASE_PARTIAL_DERIVATIVE_FACTOR_ID_FLOAT_PRECISION) + 'f}'
