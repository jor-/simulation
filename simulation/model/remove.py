...
def _main():
    ...
    parser.add_argument('-c', '--concentrations_index', type=int, help='The concentration index that should be used.')
    parser.add_argument('-t', '--time_step', type=int, default=None, help='The time step of the model that should be used. Default: 1')
    parser.add_argument('-p', '--parameter_set_index', type=int, default=None, help='The model parameter index that should be used. If none is specified, all parameter sets for the concentration index are removed.')
